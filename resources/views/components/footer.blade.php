      ...
      <div class="col-xl-11 col-xxl-10 mx-auto">
        <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-400 mt-n50p mb-n5 footer-cta" style="background:{{$settings['main_color']}}">
          <div class="card-body p-6 p-md-11 d-lg-flex flex-row align-items-lg-center justify-content-md-between text-center text-lg-start">
            <h3 class="display-6 mb-6 mb-lg-0 pe-lg-15 pe-xxl-18 text-white">يثق بنا جميع عملائنا. انضم إليهم باستخدام خدماتنا وتنمية عملك.
            </h3>
            <a href="{{route('contact')}}" class="btn btn-white rounded-pill mb-0 text-nowrap">اطلب الخدمة</a>
          </div>
          <!--/.card-body -->
        </div>
        <!--/.card -->
  ...
  <div class="container pb-4 text-center" >
    <div class="row mt-n10 mt-lg-0">
      <div class="col-xl-12 mx-auto">
        ...
        <!--/.row -->
        <p class="text-center"> جميع الحقوق محفوظة © {{date('Y')}} <a href="/"> {{$settings['website_name']}}   </a></p>
